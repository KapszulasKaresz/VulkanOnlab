...
void main() {
	...
	vec3 kd = mix(mix(texture(texSampler1, texCoord).xyz, vec3(0.525000, 0.236250, 0.236250), vec3(0.500000, 0.500000, 0.500000)), vec3(0.525000, 0.236250, 0.236250), vec3(0.500000, 0.500000, 0.500000));
	vec3 ka = mat.ka;
